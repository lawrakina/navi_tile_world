...
{
    [CustomEditor(typeof(Runtime.Mono.StateMachineBehaviour), true)]
    public class StateMachineEditor : UnityEditor.Editor
    {
        private Runtime.Mono.StateMachineBehaviour _target;

        private static EditorConfig Config => EditorConfig.Instance;

        private void OnEnable()
        {
            _target = target as Runtime.Mono.StateMachineBehaviour;
        }
