...
public class Joystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    [SerializeField] protected bool hideJoystick;
    [SerializeField] protected bool setInDefaultPos;
    ...
    protected virtual void Start()
    {
        ...
        defaultPos = background.position;
        defaultPos.x = (float) Screen.width / 2;
    }
